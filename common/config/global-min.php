...
define('DEFAULT_APPLICATION_ID', ''); // Default Application ID, should not change this value

// SETTINGS
define('CACHE_ENABLED', true);
define('LANGUAGES_ENABLED', false); // Multiple Languages or not
define('DB_LANGUAGES_ENABLED', false); // Multiple Languages or not
...
define('API_CHECK_FOOTPRINT', false); // in API Actions, check Time and FootPrint
define('API_CHECK_TOKEN', false); // in API Actions, check Tokens
...
define('WIDGETS_ENABLED', false); // Manage Widgets and Properties
