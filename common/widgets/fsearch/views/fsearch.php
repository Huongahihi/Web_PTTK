...
if(!isset($categories)){
    ...
    if($search_type == 'product') $categories = Product::getModelCategories('product');
    if($search_type == 'blog') $categories = CmsBlogs::getModelCategories('blog');

}
else $categories = Product::getModelCategories('product');
