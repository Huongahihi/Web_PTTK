...
class FFileInput extends FileInput
{
    ...
    public function run()
    {
        ...
        if ($this->display_type == FFileInput::TYPE_BROWSE) {
            ...
            $ratio1 = 12;
            echo '<div class="col-md-12"><div style="padding-left:0px" class="col-md-11">' . $result . '</div><div class="col-md-1" style="margin-top:-15px">' . FHtml::showImage(FHtml::getFieldValue($this->model, $this->attribute), FHtml::getImageFolder($this->model), 0, '50px') . '</div></div>';
