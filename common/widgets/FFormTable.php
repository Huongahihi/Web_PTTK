        ...
        for ($row = 1; $row <= $rows; $row++) {
            ...
            for ($col = 1; $col <= $cols; $col++) {
                ...
                if ($labelWidth > 0) { // has Label
                    ...
                    $content .= key_exists('label', $settings) ? FHtml::t('common', $settings['label']) : FHtml::getFieldLabel($this->model, $attribute);
                ...
                if ($labelWidth == 0) {
                    $content .= '<div class="form-label" style="padding:15px">' . key_exists('label', $settings) ? FHtml::t('common', $settings['label']) : FHtml::getFieldLabel($this->model, $attribute) . '</div>';
