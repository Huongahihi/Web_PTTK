...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'birth_date')->date() ?>
       ...
       <?= $form->field($model, 'rates')->rate() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'lang')->select(FHtml::getComboArray('music_artist', 'music_artist', 'lang', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'type')->select(FHtml::getComboArray('music_artist', 'music_artist', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'status')->select(FHtml::getComboArray('music_artist', 'music_artist', 'status', true, 'id', 'name'))->labelSpan(6) ?>
