...
/* @var $model backend\modules\music\models\MusicArtist */
            ...
            <div class="portlet light">
                ...
                <div class="portlet-title tabbable-line hidden-print">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#tab_1_5" data-toggle="tab"><?= FHtml::t('common', 'MusicPlaylist')?></a>
                        </li>
                                                </ul>
                </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        'real_name'   => ['value' => $form->fieldNoLabel($model, 'real_name')->textInput(), 'columnOptions'               => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        'birth_date'  => ['value' => $form->fieldNoLabel($model, 'birth_date')->date(), 'columnOptions'                   => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        'rates'       => ['value' => $form->fieldNoLabel($model, 'rates')->rate(), 'columnOptions'                        => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            ...
                                            'lang'        => ['value' => $form->fieldNoLabel($model, 'lang')             ->select(FHtml::getComboArray('music_artist', 'music_artist', 'lang', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'type'        => ['value' => $form->fieldNoLabel($model, 'type')             ->select(FHtml::getComboArray('music_artist', 'music_artist', 'type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'status'      => ['value' => $form->fieldNoLabel($model, 'status')           ->select(FHtml::getComboArray('music_artist', 'music_artist', 'status', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
...
'image' => ['value' => $form->fieldNoLabel($model, 'image')->image(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                ...
                                <div class="tab-pane row" id="tab_1_5">
                                    <div class="col-md-12">
                                        <?= FormRelations::widget([
                                            'model' => $model, 'form' => $form,
                                            'field_name' => 'MusicPlaylist', 'object_type' => 'music_playlist', 'relation_type' => '',
                                            'canEdit' => $canEdit, 'moduleKey' => $moduleKey, 'modulePath' => $modulePath
                                        ]) ?>
                                    </div>
                                </div>
