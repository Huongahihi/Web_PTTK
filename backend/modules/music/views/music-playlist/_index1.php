...
/* @var $searchModel backend\modules\music\models\MusicPlaylistSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$moduleName = isset($moduleName) ? $moduleName : 'MusicPlaylist';
$moduleTitle = isset($moduleTitle) ? $moduleTitle : 'Music Playlist';
$moduleKey = isset($moduleKey) ? $moduleKey : 'music-playlist';
$object_type = isset($object_type) ? $object_type : 'music_playlist';
...
<div class="row">
    <div class="col-md-10 col-xs-12">
        <div class="music-playlist-index">
