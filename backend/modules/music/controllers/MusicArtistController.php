...
use backend\modules\music\models\MusicArtistSearch;
 ...
 */
class MusicArtistController extends AdminController
{
    protected $moduleName = 'MusicArtist';
    protected $moduleTitle = 'Music Artist';
    protected $moduleKey = 'music_artist';
    protected $object_type = 'music_artist';
...
/**
    ...
    {    
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = MusicArtist::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['MusicArtist']);
           $post['MusicArtist'] = $posted;
    ...
    /**
     * Delete an existing MusicArtist model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing MusicArtist model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
