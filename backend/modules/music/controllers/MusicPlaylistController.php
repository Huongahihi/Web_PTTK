...
use backend\modules\music\models\MusicPlaylistSearch;
...
/**
 * MusicPlaylistController implements the CRUD actions for MusicPlaylist model.
 */
class MusicPlaylistController extends AdminController
{
    protected $moduleName = 'MusicPlaylist';
    protected $moduleTitle = 'Music Playlist';
    protected $moduleKey = 'music_playlist';
    protected $object_type = 'music_playlist';
...
/**
    ...
    /**
     * Lists all MusicPlaylist models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new MusicPlaylistSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = MusicPlaylist::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['MusicPlaylist']);
           $post['MusicPlaylist'] = $posted;
    ...
    /**
     * Displays a single MusicPlaylist model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new MusicPlaylist model.
    ...
    /**
     * Updates an existing MusicPlaylist model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing MusicPlaylist model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing MusicPlaylist model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the MusicPlaylist model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return MusicPlaylist the loaded model
