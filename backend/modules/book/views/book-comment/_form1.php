                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                               <?= $form->field($model, 'user_id')->select(FHtml::getComboArray('book_comment', 'book_comment', 'user_id', true, 'id', 'name')) ?>

       <?= $form->field($model, 'book_id')->select(FHtml::getComboArray('book_comment', 'book_comment', 'book_id', true, 'id', 'name')) ?>

       <?= $form->field($model, 'chapter_id')->select(FHtml::getComboArray('book_comment', 'book_comment', 'chapter_id', true, 'id', 'name')) ?>

       <?= $form->field($model, 'name')->select(FHtml::getComboArray('book_comment', 'book_comment', 'name', true, 'id', 'name')) ?>
