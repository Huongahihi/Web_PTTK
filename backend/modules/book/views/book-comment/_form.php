                            ...
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        'user_id' => ['value' => $form->fieldNoLabel($model, 'user_id')->select(FHtml::getComboArray('book_comment', 'book_comment', 'user_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'book_id' => ['value' => $form->fieldNoLabel($model, 'book_id')->select(FHtml::getComboArray('book_comment', 'book_comment', 'book_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'chapter_id' => ['value' => $form->fieldNoLabel($model, 'chapter_id')->select(FHtml::getComboArray('book_comment', 'book_comment', 'chapter_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'name' => ['value' => $form->fieldNoLabel($model, 'name')->select(FHtml::getComboArray('book_comment', 'book_comment', 'name', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
