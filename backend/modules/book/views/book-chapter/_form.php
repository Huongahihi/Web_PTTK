                            ...
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        'book_id' => ['value' => $form->fieldNoLabel($model, 'book_id')->select(FHtml::getComboArray('book_chapter', 'book_chapter', 'book_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'chapter_number' => ['value' => $form->fieldNoLabel($model, 'chapter_number')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
...
'content' => ['value' => $form->fieldNoLabel($model, 'content')->html() , 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        -->
                                            ...
                                            'type' => ['value' => $form->fieldNoLabel($model, 'type')->select(FHtml::getComboArray('book_chapter', 'book_chapter', 'type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
