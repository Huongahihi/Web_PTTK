    ...
    <div class="row">
                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                               <?= $form->field($model, 'book_id')->select(FHtml::getComboArray('book_chapter', 'book_chapter', 'book_id', true, 'id', 'name')) ?>

       <?= $form->field($model, 'chapter_number')->numeric() ?>
       ...
       <?= $form->field($model, 'content')->html()  ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('book_chapter', 'book_chapter', 'type', true, 'id', 'name'))->labelSpan(6) ?>
