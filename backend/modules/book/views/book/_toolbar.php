...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'book', 'book', 'type'),
FHtml::buildBulkActionsMenu('', 'book', 'book', 'category_id'),
FHtml::buildBulkActionsMenu('', 'book', 'book', 'is_feature'),
FHtml::buildBulkActionsMenu('', 'book', 'book', 'is_active'),
