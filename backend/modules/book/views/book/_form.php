...
'publisher' => ['value' => $form->fieldNoLabel($model, 'publisher')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'description' => ['value' => $form->fieldNoLabel($model, 'description')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'view_count' => ['value' => $form->fieldNoLabel($model, 'view_count')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'like_count' => ['value' => $form->fieldNoLabel($model, 'like_count')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        -->
                                            ...
                                            'type' => ['value' => $form->fieldNoLabel($model, 'type')->select(['classic'=>'Classic', 'ebook' => 'Ebook']), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'category_id' => ['value' => $form->fieldNoLabel($model, 'category_id_array')->selectMany(FHtml::getComboArray('select * from object_category')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            ...
                                            'is_feature' => ['value' => $form->fieldNoLabel($model, 'is_feature')->checkbox() , 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
...
'attachment' => ['value' => $form->fieldNoLabel($model, 'attachment')->file(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
