...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'view_count')->numeric() ?>

       <?= $form->field($model, 'like_count')->numeric() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('book', 'book', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'category_id')->select(FHtml::getComboArray('book', 'book', 'category_id', true, 'id', 'name'))->labelSpan(6) ?>
       ...
       <?= $form->field($model, 'attachment')->file() ?>
