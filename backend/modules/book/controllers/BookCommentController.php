...
use backend\modules\book\models\BookCommentSearch;
...
/**
 * BookCommentController implements the CRUD actions for BookComment model.
 */
class BookCommentController extends AdminController
{
    protected $moduleName = 'BookComment';
    protected $moduleTitle = 'Book Comment';
    protected $moduleKey = 'book_comment';
    protected $object_type = 'book_comment';
...
/**
    ...
    {    
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = BookComment::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['BookComment']);
           $post['BookComment'] = $posted;
    ...
    /**
     * Displays a single BookComment model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new BookComment model.
    ...
    /**
     * Updates an existing BookComment model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing BookComment model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing BookComment model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the BookComment model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BookComment the loaded model
