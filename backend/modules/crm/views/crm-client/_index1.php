...
/* @var $searchModel backend\modules\crm\models\CrmClientSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$moduleName = isset($moduleName) ? $moduleName : 'CrmClient';
$moduleTitle = isset($moduleTitle) ? $moduleTitle : 'Crm Client';
$moduleKey = isset($moduleKey) ? $moduleKey : 'crm-client';
$object_type = isset($object_type) ? $object_type : 'crm_client';
