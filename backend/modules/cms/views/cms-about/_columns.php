...
/*
    ...
    [ //name: thumbnail, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showImageThumbnail($model-> thumbnail, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'cms-about'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
        'editableOptions'=>[                       
    ...
    //[ //name: content, dbType: text, phpType: string, size: , allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> content, '', 'cms_about', 'content','text','cms-about'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
    ...
    [ //name: color, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> color, FHtml::SHOW_COLOR, 'cms_about', 'color','varchar(100)','cms-about'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'20px',
    ...
    //[ //name: sort_order, dbType: int(5), phpType: integer, size: 5, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> sort_order, FHtml::SHOW_NUMBER, 'cms_about', 'sort_order','int(5)','cms-about'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
    ...
    [ //name: lang, dbType: varchar(50), phpType: string, size: 50, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> lang, FHtml::SHOW_LABEL, 'cms_about', 'lang','varchar(50)','cms-about'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        ...
        'filter'=> FHtml::getComboArray('cms_about', 'cms_about', 'lang', true, 'id', 'name'),
    ],
    ...
    [ //name: is_top, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_top, FHtml::SHOW_BOOLEAN, 'cms_about', 'is_top','tinyint(1)','cms-about'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
    ...
    //[ //name: created_user, dbType: varchar(150), phpType: string, size: 150, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> created_user, FHtml::SHOW_LABEL, 'cms_about', 'created_user','varchar(150)','cms-about'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'100px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('cms_about', 'cms_about', 'created_user', true, 'id', 'name'),
    //],
    ...
    //[ //name: modified_user, dbType: varchar(150), phpType: string, size: 150, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> modified_user, FHtml::SHOW_LABEL, 'cms_about', 'modified_user','varchar(150)','cms-about'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'100px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('cms_about', 'cms_about', 'modified_user', true, 'id', 'name'),
    //],
    [
