...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cms_about', 'cms_about', 'lang'),
FHtml::buildBulkActionsMenu('', 'cms_about', 'cms_about', 'is_active'),
FHtml::buildBulkActionsMenu('', 'cms_about', 'cms_about', 'is_top'),
