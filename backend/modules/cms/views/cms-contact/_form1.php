...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'map_url')->textarea(['rows' => 3]) ?>

       <?= $form->field($model, 'city')->select(FHtml::getComboArray('cms_contact', 'cms_contact', 'city', true, 'id', 'name')) ?>

       <?= $form->field($model, 'country')->select(FHtml::getComboArray('cms_contact', 'cms_contact', 'country', true, 'id', 'name')) ?>

       <?= $form->field($model, 'lat')->numeric() ?>

       <?= $form->field($model, 'long')->numeric() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('cms_contact', 'cms_contact', 'type', true, 'id', 'name'))->labelSpan(6) ?>
                                            ...
                                            <div class="col-md-6">
                                                   ...
                                                   <?= $form->field($model, 'live_chat')->textarea(['rows' => 3]) ?>
