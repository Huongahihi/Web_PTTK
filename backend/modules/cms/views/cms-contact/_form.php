...
'map_url' => ['value' => $form->fieldNoLabel($model, 'map_url')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'city' => ['value' => $form->fieldNoLabel($model, 'city')->select(FHtml::getComboArray('cms_contact', 'cms_contact', 'city', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'country' => ['value' => $form->fieldNoLabel($model, 'country')->select(FHtml::getComboArray('cms_contact', 'cms_contact', 'country', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'lat' => ['value' => $form->fieldNoLabel($model, 'lat')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'long' => ['value' => $form->fieldNoLabel($model, 'long')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        -->
                                            ...
                                            'type' => ['value' => $form->fieldNoLabel($model, 'type')->select(FHtml::getComboArray('cms_contact', 'cms_contact', 'type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                                                                           ...
                                                                                           <?php echo FFormTable::widget(['model' => $model, 'title' => FHtml::t('common', 'CHAT'), 'form' => $form, 'columns' => 2, 'attributes' => [ 

                                            'live_chat' => ['value' => $form->fieldNoLabel($model, 'live_chat')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'skype' => ['value' => $form->fieldNoLabel($model, 'skype')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
