...
/* @var $model backend\modules\cms\models\CmsLinks */
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <div class="portlet light">
                ...
                <?= ($field_layout == FHtml::LAYOUT_TABLE) ? '<table class="table table-bordered">' : '' ?>                       <?= FHtml::showModelField($model,'link_url', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'cms_links') ?>

       <?= FHtml::showModelField($model,'category_id', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'cms_links', 'category_id', 'int(11)', '', '') ?>

       <?= FHtml::showModelField($model,'id', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'cms_links', 'id', 'int(11)', '', '') ?>

       <?= FHtml::showModelField($model,'title', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'cms_links') ?>

       <?= FHtml::showModelField($model,'content', FHtml::SHOW_HTML, $field_layout, $form_label_CSS, 'cms_links', 'content', 'text', '', '') ?>

       <?= FHtml::showModelField($model,'type', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'cms_links') ?>
