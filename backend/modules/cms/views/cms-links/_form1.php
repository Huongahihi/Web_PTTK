    ...
    <div class="row">
       ...
       <?= $form->field($model, 'content')->html()  ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'category_id')->select(FHtml::getComboArray('cms_links', 'cms_links', 'category_id', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'type')->select(FHtml::getComboArray('cms_links', 'cms_links', 'type', true, 'id', 'name'))->labelSpan(6) ?>
