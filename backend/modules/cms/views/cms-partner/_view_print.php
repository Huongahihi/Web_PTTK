    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <div class="portlet light">
                ...
                <?= ($field_layout == FHtml::LAYOUT_TABLE) ? '<table class="table table-bordered">' : '' ?>                       <?= FHtml::showModelField($model,'is_active', FHtml::SHOW_ACTIVE, $field_layout, $form_label_CSS, 'cms_partner', 'is_active', 'tinyint(1)', '', '') ?>

       <?= FHtml::showModelField($model,'id', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'cms_partner', 'id', 'int(11)', '', '') ?>

       <?= FHtml::showModelField($model,'image', FHtml::SHOW_IMAGE, $field_layout, $form_label_CSS, 'cms_partner') ?>

       <?= FHtml::showModelField($model,'name', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'cms_partner') ?>

       <?= FHtml::showModelField($model,'overview', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'cms_partner') ?>

       <?= FHtml::showModelField($model,'linkurl', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'cms_partner') ?>
