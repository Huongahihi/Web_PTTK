...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'user_id')->select(FHtml::getComboArray('cms_feedback', 'cms_feedback', 'user_id', true, 'id', 'name')) ?>
       ...
       <?= $form->field($model, 'ip_address')->textInput() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('cms_feedback', 'cms_feedback', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'status')->select(FHtml::getComboArray('cms_feedback', 'cms_feedback', 'status', true, 'id', 'name'))->labelSpan(6) ?>
