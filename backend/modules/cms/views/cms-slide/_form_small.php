...
'transition_speed' => ['type' => FHtml::INPUT_RAW, 'value' => $form->fieldNoLabel($model, 'transition_speed')->select(FHtml::getComboArray('cms_slide', 'cms_slide', 'transition_speed', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1]],
'alignment' => ['type' => FHtml::INPUT_RAW, 'value' => $form->fieldNoLabel($model, 'alignment')->select(FHtml::getComboArray('cms_slide', 'cms_slide', 'alignment', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1]],
