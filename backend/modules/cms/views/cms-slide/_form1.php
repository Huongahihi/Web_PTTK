...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'transition_speed')->select(FHtml::getComboArray('cms_slide', 'cms_slide', 'transition_speed', true, 'id', 'name')) ?>

       <?= $form->field($model, 'alignment')->select(FHtml::getComboArray('cms_slide', 'cms_slide', 'alignment', true, 'id', 'name')) ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'transition_type')->select(FHtml::getComboArray('cms_slide', 'cms_slide', 'transition_type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'lang')->select(FHtml::getComboArray('cms_slide', 'cms_slide', 'lang', true, 'id', 'name'))->labelSpan(6) ?>
                                            ...
                                            <div class="col-md-6">
                                                   ...
                                                   <?= $form->field($model, 'url1_label')->textInput() ?>

       <?= $form->field($model, 'url1_link')->textInput() ?>



                                                                                               <?= FHtml::showGroupHeader('More') ?>
                                                   <?= $form->field($model, 'url2_label')->textInput() ?>

       <?= $form->field($model, 'url2_link')->textInput() ?>



                                                                                               <?= FHtml::showGroupHeader('More') ?>
                                                   <?= $form->field($model, 'url3_label')->textInput() ?>

       <?= $form->field($model, 'url3_link')->textInput() ?>
