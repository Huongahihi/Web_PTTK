...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cms_slide', 'cms_slide', 'transition_type'),
FHtml::buildBulkActionsMenu('', 'cms_slide', 'cms_slide', 'lang'),
FHtml::buildBulkActionsMenu('', 'cms_slide', 'cms_slide', 'is_active'),
