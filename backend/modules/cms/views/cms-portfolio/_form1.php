...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'testimonial_id')->select(FHtml::getComboArray('@cms_testimonial', 'cms_testimonial', 'testimonial_id', true, 'id', 'name')) ?>

       <?= $form->field($model, 'product_id')->select(FHtml::getComboArray('@product', 'product', 'product_id', true, 'id', 'name')) ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'status')->select(FHtml::getComboArray('cms_portfolio', 'cms_portfolio', 'status', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'product_category_id')->selectMany(FHtml::getComboArray('@object_category', 'object_category', 'product_category_id', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'lang')->select(FHtml::getComboArray('cms_portfolio', 'cms_portfolio', 'lang', true, 'id', 'name'))->labelSpan(6) ?>
