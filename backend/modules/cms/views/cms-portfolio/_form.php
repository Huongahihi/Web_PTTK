                                ...
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        <?php echo FFormTable::widget(['model' => $model, 'form' => $form, 'columns' => 1, 'attributes' => [
                                            ...
                                            'testimonial_id' => ['value' => $form->fieldNoLabel($model, 'testimonial_id')->select(FHtml::getComboArray('@cms_testimonial', 'cms_testimonial', 'testimonial_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'product_id' => ['value' => $form->fieldNoLabel($model, 'product_id')->select(FHtml::getComboArray('@product', 'product', 'product_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => FHtml::t('common', 'Group'), 'form' => $form, 'columns' => 2, 'attributes' => [
                                            ...
                                            'status' => ['value' => $form->fieldNoLabel($model, 'status')->select(FHtml::getComboArray('cms_portfolio', 'cms_portfolio', 'status', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'product_category_id' => ['value' => $form->fieldNoLabel($model, 'product_category_id')->selectMany(FHtml::getComboArray('@object_category', 'object_category', 'product_category_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'lang' => ['value' => $form->fieldNoLabel($model, 'lang')->select(FHtml::getComboArray('cms_portfolio', 'cms_portfolio', 'lang', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
