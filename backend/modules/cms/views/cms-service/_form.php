...
'linkurl' => ['value' => $form->fieldNoLabel($model, 'linkurl')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        -->
                                            ...
                                            'lang' => ['value' => $form->fieldNoLabel($model, 'lang')->select(FHtml::getComboArray('cms_service', 'cms_service', 'lang', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
