...
/*
    ...
    [ //name: id, dbType: bigint(20), phpType: string, size: 20, allowNull:  
        ...
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'cms_service', 'id','bigint(20)','cms-service') . '</b>' ; }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    [ //name: thumbnail, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showImageThumbnail($model-> thumbnail, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'cms-service'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
        'editableOptions'=>[                       
    ...
    //[ //name: image, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showImageThumbnail($model-> image, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'cms-service'); }, 
        //'hAlign'=>'center',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
    ...
    //[ //name: content, dbType: text, phpType: string, size: , allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> content, '', 'cms_service', 'content','text','cms-service'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
    ...
    //[ //name: sort_order, dbType: int(5), phpType: integer, size: 5, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> sort_order, FHtml::SHOW_NUMBER, 'cms_service', 'sort_order','int(5)','cms-service'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
    ...
    [ //name: lang, dbType: varchar(50), phpType: string, size: 50, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> lang, FHtml::SHOW_LABEL, 'cms_service', 'lang','varchar(50)','cms-service'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        ...
        'filter'=> FHtml::getComboArray('cms_service', 'cms_service', 'lang', true, 'id', 'name'),
    ],
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_active, FHtml::SHOW_BOOLEAN, 'cms_service', 'is_active','tinyint(1)','cms-service'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
    [ //name: is_top, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_top, FHtml::SHOW_BOOLEAN, 'cms_service', 'is_top','tinyint(1)','cms-service'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
    ...
    //[ //name: created_user, dbType: varchar(150), phpType: string, size: 150, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> created_user, FHtml::SHOW_LABEL, 'cms_service', 'created_user','varchar(150)','cms-service'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'100px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('cms_service', 'cms_service', 'created_user', true, 'id', 'name'),
    //],
    ...
    //[ //name: modified_user, dbType: varchar(150), phpType: string, size: 150, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> modified_user, FHtml::SHOW_LABEL, 'cms_service', 'modified_user','varchar(150)','cms-service'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'100px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('cms_service', 'cms_service', 'modified_user', true, 'id', 'name'),
    //],
    [
