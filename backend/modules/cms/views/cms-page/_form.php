...
'page_title' => ['value' => $form->fieldNoLabel($model, 'page_title')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'page_slug' => ['value' => $form->fieldNoLabel($model, 'page_slug')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'page_description' => ['value' => $form->fieldNoLabel($model, 'page_description')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'page_content' => ['value' => $form->fieldNoLabel($model, 'page_content')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'page_width' => ['value' => $form->fieldNoLabel($model, 'page_width')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'page_background' => ['value' => $form->fieldNoLabel($model, 'page_background')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'body_css' => ['value' => $form->fieldNoLabel($model, 'body_css')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'body_style' => ['value' => $form->fieldNoLabel($model, 'body_style')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'page_style' => ['value' => $form->fieldNoLabel($model, 'page_style')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'page_script' => ['value' => $form->fieldNoLabel($model, 'page_script')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        -->
                                               ...
                                               <?php echo FFormTable::widget(['model' => $model, 'title' => FHtml::t('common', 'Group'), 'form' => $form, 'columns' => 2, 'attributes' => [ 
                                                ...
                                                'is_active' => ['value' => $form->fieldNoLabel($model, 'is_active')->checkbox() , 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                                   'views_count' => ['value' => $form->fieldNoLabel($model, 'views_count')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
