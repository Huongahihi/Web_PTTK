...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'keywords')->selectMany(FHtml::getComboArray('cms_page', 'cms_page', 'keywords', true, 'id', 'name')) ?>

       <?= $form->field($model, 'page_title')->textInput() ?>

       <?= $form->field($model, 'page_slug')->textInput() ?>

       <?= $form->field($model, 'page_description')->textarea(['rows' => 3]) ?>

       <?= $form->field($model, 'page_content')->textarea(['rows' => 3]) ?>

       <?= $form->field($model, 'page_width')->textInput() ?>

       <?= $form->field($model, 'page_background')->textInput() ?>

       <?= $form->field($model, 'body_css')->textInput() ?>

       <?= $form->field($model, 'body_style')->textInput() ?>

       <?= $form->field($model, 'page_style')->textarea(['rows' => 3]) ?>

       <?= $form->field($model, 'page_script')->textarea(['rows' => 3]) ?>

       <?= $form->field($model, 'views_count')->numeric() ?>
       ...
       <?= $form->field($model, 'page_image')->image() ?>
