...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'page_code')->textInput() ?>
       ...
       <?= $form->field($model, 'columns_count')->numeric() ?>

       <?= $form->field($model, 'items_count')->numeric() ?>

       <?= $form->field($model, 'width_css')->textInput() ?>

       <?= $form->field($model, 'background_css')->textInput() ?>

       <?= $form->field($model, 'color_bg')->color() ?>

       <?= $form->field($model, 'color')->color() ?>

       <?= $form->field($model, 'style')->textarea(['rows' => 3]) ?>

       <?= $form->field($model, 'viewmore_url')->textInput() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'display_type')->selectMany(FHtml::getComboArray('cms_widgets', 'cms_widgets', 'display_type', true, 'id', 'name'))->labelSpan(6) ?>
                                            ...
                                            <div class="col-md-6">
                                                   ...
                                                   <?= $form->field($model, 'item_style')->textarea(['rows' => 3]) ?>

       <?= $form->field($model, 'item_layout')->textarea(['rows' => 3]) ?>



                                                                                               <?= FHtml::showGroupHeader('More') ?>
                                                   <?= $form->field($model, 'show_viewmore')->checkbox()  ?>

       <?= $form->field($model, 'show_headline')->checkbox()  ?>
