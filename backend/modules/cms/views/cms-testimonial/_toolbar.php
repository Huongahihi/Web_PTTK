...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cms_testimonial', 'cms_testimonial', 'is_active'),
FHtml::buildBulkActionsMenu('', 'cms_testimonial', 'cms_testimonial', 'is_top'),
