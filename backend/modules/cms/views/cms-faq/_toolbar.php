...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cms_faq', 'cms_faq', 'type'),
FHtml::buildBulkActionsMenu('', 'cms_faq', 'cms_faq', 'lang'),
FHtml::buildBulkActionsMenu('', 'cms_faq', 'cms_faq', 'is_active'),
FHtml::buildBulkActionsMenu('', 'cms_faq', 'cms_faq', 'is_top'),
