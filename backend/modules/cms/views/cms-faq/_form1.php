                            ...
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        <?= FHtml::showGroupHeader('Groups') ?>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <?= $form->field($model, 'type')->select(FHtml::getComboArray('cms_faq', 'cms_faq', 'type', true, 'id', 'name'))->labelSpan(6) ?>

                                                <?= $form->field($model, 'lang')->select(FHtml::getComboArray('cms_faq', 'cms_faq', 'lang', true, 'id', 'name'))->labelSpan(6) ?>
