...
/*
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'cms_employee', 'id','int(11)','cms-employee') . '</b>' ; }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    [ //name: image, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showImageThumbnail($model-> image, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'cms-employee'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
        'editableOptions'=>[                       
    ...
    [ //name: position, dbType: varchar(255), phpType: string, size: 255, allowNull: 1 
    ...
    //[ //name: content, dbType: text, phpType: string, size: , allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> content, '', 'cms_employee', 'content','text','cms-employee'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'contentOptions'=>['class'=>'col-md-1 nowrap'],
    //],
    ...
    //[ //name: linkedin, dbType: varchar(255), phpType: string, size: 255, allowNull: 1 
        //'class' => FHtml::getColumnClass($object_type, 'linkedin', $form_type),
        //'format'=>'raw',
        //'attribute'=>'linkedin',
        //'visible' => FHtml::isVisibleInGrid($object_type, 'linkedin', $form_type),
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'contentOptions'=>['class'=>'col-md-1 nowrap'],
        //'editableOptions'=>[                       
    ...
    //[ //name: sort_order, dbType: int(5), phpType: integer, size: 5, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> sort_order, FHtml::SHOW_NUMBER, 'cms_employee', 'sort_order','int(5)','cms-employee'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
                        ...
                        //],
    //],
    //[ //name: is_contact, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        //'class'=>'kartik\grid\BooleanColumn',
        //'format'=>'raw',
        //'attribute'=>'is_contact',
        //'visible' => FHtml::isVisibleInGrid($object_type, 'is_contact', $form_type),
        //'value' => function($model) { return FHtml::showContent($model-> is_contact, FHtml::SHOW_BOOLEAN, 'cms_employee', 'is_contact','tinyint(1)','cms-employee'); }, 
        //'hAlign'=>'center',
        //'vAlign'=>'middle',
        //'width'=>'20px',
    //],
    [ //name: is_top, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_top, FHtml::SHOW_BOOLEAN, 'cms_employee', 'is_top','tinyint(1)','cms-employee'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_active, FHtml::SHOW_BOOLEAN, 'cms_employee', 'is_active','tinyint(1)','cms-employee'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
    ...
    //[ //name: created_user, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> created_user, FHtml::SHOW_LABEL, 'cms_employee', 'created_user','varchar(100)','cms-employee'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'80px',
        ...
        //'filter'=> FHtml::getComboArray('cms_employee', 'cms_employee', 'created_user', true, 'id', 'name'),
    //],
    ...
    //[ //name: modified_user, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> modified_user, FHtml::SHOW_LABEL, 'cms_employee', 'modified_user','varchar(100)','cms-employee'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'80px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('cms_employee', 'cms_employee', 'modified_user', true, 'id', 'name'),
    //],
    [
