                                ...
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        <?php echo FFormTable::widget(['model' => $model, 'form' => $form, 'columns' => 1, 'attributes' => [
                                            ...
                                            'position' => ['value' => $form->fieldNoLabel($model, 'position')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            ...
                                            'linkedin' => ['value' => $form->fieldNoLabel($model, 'linkedin')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => FHtml::t('common', 'is'), 'form' => $form, 'columns' => 2, 'attributes' => [
                                            ...
                                            'is_contact' => ['value' => $form->fieldNoLabel($model, 'is_contact')->checkbox(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
