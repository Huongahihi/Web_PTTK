...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cms_employee', 'cms_employee', 'is_contact'),
FHtml::buildBulkActionsMenu('', 'cms_employee', 'cms_employee', 'is_top'),
FHtml::buildBulkActionsMenu('', 'cms_employee', 'cms_employee', 'is_active'),
