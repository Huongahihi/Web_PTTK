    ...
    <div class="row">
       ...
       <?= $form->field($model, 'linkurl')->textInput() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('cms_article', 'cms_article', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'lang')->select(FHtml::getComboArray('cms_article', 'cms_article', 'lang', true, 'id', 'name'))->labelSpan(6) ?>
