...
* This is the customized model class for table "CmsArticle".
*/
...
$moduleName = 'CmsArticle';
$moduleTitle = 'Cms Article';
$moduleKey = 'cms-article';
$object_type = 'cms_article';
...
/*
    ...
    [ //name: id, dbType: bigint(20), phpType: string, size: 20, allowNull:  
        ...
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'cms_article', 'id','bigint(20)','cms-article') . '</b>' ; }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    [ //name: thumbnail, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showImageThumbnail($model-> thumbnail, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'cms-article'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
        'editableOptions'=>[                       
    ...
    //[ //name: image, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showImageThumbnail($model-> image, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'cms-article'); }, 
        //'hAlign'=>'center',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
    ...
    //[ //name: banner, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showImageThumbnail($model-> banner, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'cms-article'); }, 
        //'hAlign'=>'center',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
    ...
    //[ //name: content, dbType: text, phpType: string, size: , allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> content, '', 'cms_article', 'content','text','cms-article'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'contentOptions'=>['class'=>'col-md-1 nowrap'],
    //],
    ...
    //[ //name: sort_order, dbType: int(5), phpType: integer, size: 5, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> sort_order, FHtml::SHOW_NUMBER, 'cms_article', 'sort_order','int(5)','cms-article'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
                        ...
                        //],
    //],
    [ //name: type, dbType: varchar(50), phpType: string, size: 50, allowNull: 1 
        'class' => FHtml::getColumnClass($object_type, 'type', $form_type),
        'format'=>'raw',
        'attribute'=>'type',
        'visible' => FHtml::isVisibleInGrid($object_type, 'type', $form_type),
        'value' => function($model) { return FHtml::showContent($model-> type, FHtml::SHOW_LABEL, 'cms_article', 'type','varchar(50)','cms-article'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        ...
        'filter'=> FHtml::getComboArray('cms_article', 'cms_article', 'type', true, 'id', 'name'),
    ],
    [ //name: lang, dbType: varchar(50), phpType: string, size: 50, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> lang, FHtml::SHOW_LABEL, 'cms_article', 'lang','varchar(50)','cms-article'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('cms_article', 'cms_article', 'lang', true, 'id', 'name'),
    ],
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_active, FHtml::SHOW_BOOLEAN, 'cms_article', 'is_active','tinyint(1)','cms-article'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
    [ //name: is_top, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_top, FHtml::SHOW_BOOLEAN, 'cms_article', 'is_top','tinyint(1)','cms-article'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
    //[ //name: created_date, dbType: date, phpType: string, size: , allowNull: 1 
        ...
        //'editableOptions'=>[                       
                        ...
                        //],
    //],
    //[ //name: created_user, dbType: varchar(150), phpType: string, size: 150, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> created_user, FHtml::SHOW_LABEL, 'cms_article', 'created_user','varchar(150)','cms-article'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'100px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('cms_article', 'cms_article', 'created_user', true, 'id', 'name'),
    //],
    //[ //name: modified_date, dbType: date, phpType: string, size: , allowNull: 1 
        ...
        //'editableOptions'=>[                       
                        ...
                        //],
    //],
    //[ //name: modified_user, dbType: varchar(150), phpType: string, size: 150, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> modified_user, FHtml::SHOW_LABEL, 'cms_article', 'modified_user','varchar(150)','cms-article'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'100px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('cms_article', 'cms_article', 'modified_user', true, 'id', 'name'),
    //],
    [
