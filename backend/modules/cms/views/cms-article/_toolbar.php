...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cms_article', 'cms_article', 'type'),
FHtml::buildBulkActionsMenu('', 'cms_article', 'cms_article', 'lang'),
FHtml::buildBulkActionsMenu('', 'cms_article', 'cms_article', 'is_active'),
FHtml::buildBulkActionsMenu('', 'cms_article', 'cms_article', 'is_top'),
