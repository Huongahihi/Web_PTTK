...
use backend\modules\cms\models\CmsLinksSearch;
...
/**
 * CmsLinksController implements the CRUD actions for CmsLinks model.
 */
class CmsLinksController extends AdminController
{
    protected $moduleName = 'CmsLinks';
    protected $moduleTitle = 'Cms Links';
    protected $moduleKey = 'cms_links';
    protected $object_type = 'cms_links';
...
/**
    ...
    /**
     * Lists all CmsLinks models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CmsLinksSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsLinks::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsLinks']);
           $post['CmsLinks'] = $posted;
    ...
    /**
     * Displays a single CmsLinks model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing CmsLinks model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsLinks model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsLinks model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CmsLinks model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CmsLinks the loaded model
