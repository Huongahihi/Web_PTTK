...
use backend\modules\cms\models\CmsSlideSearch;
...
/**
 * CmsSlideController implements the CRUD actions for CmsSlide model.
 */
class CmsSlideController extends AdminController
{
    protected $moduleName = 'CmsSlide';
    protected $moduleTitle = 'Cms Slide';
    protected $moduleKey = 'cms_slide';
    protected $object_type = 'cms_slide';
...
/**
    ...
    /**
     * Lists all CmsSlide models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CmsSlideSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsSlide::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsSlide']);
           $post['CmsSlide'] = $posted;
    ...
    /**
     * Displays a single CmsSlide model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing CmsSlide model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsSlide model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsSlide model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CmsSlide model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CmsSlide the loaded model
