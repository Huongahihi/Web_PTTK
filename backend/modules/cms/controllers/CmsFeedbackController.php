...
use backend\modules\cms\models\CmsFeedbackSearch;
...
/**
 * CmsFeedbackController implements the CRUD actions for CmsFeedback model.
 */
class CmsFeedbackController extends AdminController
{
    protected $moduleName = 'CmsFeedback';
    protected $moduleTitle = 'Cms Feedback';
    protected $moduleKey = 'cms_feedback';
    protected $object_type = 'cms_feedback';
...
/**
    ...
    /**
     * Lists all CmsFeedback models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CmsFeedbackSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsFeedback::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsFeedback']);
           $post['CmsFeedback'] = $posted;
    ...
    /**
     * Displays a single CmsFeedback model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CmsFeedback model.
    ...
    /**
     * Updates an existing CmsFeedback model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsFeedback model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsFeedback model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the CmsFeedback model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return CmsFeedback the loaded model
