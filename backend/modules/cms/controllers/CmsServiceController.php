...
use backend\modules\cms\models\CmsServiceSearch;
 ...
 */
class CmsServiceController extends AdminController
{
    protected $moduleName = 'CmsService';
    protected $moduleTitle = 'Cms Service';
    protected $moduleKey = 'cms_service';
    protected $object_type = 'cms_service';
...
/**
    ...
    {    
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $post = [];
           $posted = current($_POST['CmsService']);
           $post['CmsService'] = $posted;
    ...
    /**
     * Delete an existing CmsService model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsService model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
