...
use backend\modules\cms\models\CmsWidgetsSearch;
...
/**
 * CmsWidgetsController implements the CRUD actions for CmsWidgets model.
 */
class CmsWidgetsController extends AdminController
{
    protected $moduleName = 'CmsWidgets';
    protected $moduleTitle = 'Cms Widgets';
    protected $moduleKey = 'cms_widgets';
    protected $object_type = 'cms_widgets';
...
/**
    ...
    /**
     * Lists all CmsWidgets models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CmsWidgetsSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsWidgets::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsWidgets']);
           $post['CmsWidgets'] = $posted;
    ...
    /**
     * Displays a single CmsWidgets model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CmsWidgets model.
    ...
    /**
     * Updates an existing CmsWidgets model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsWidgets model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsWidgets model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CmsWidgets model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CmsWidgets the loaded model
