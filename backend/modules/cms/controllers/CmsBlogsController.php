...
use backend\modules\cms\models\CmsBlogsSearch;
...
/**
 * CmsBlogsController implements the CRUD actions for CmsBlogs model.
 */
class CmsBlogsController extends AdminController
{
    protected $moduleName = 'CmsBlogs';
    protected $moduleTitle = 'Cms Blogs';
    protected $moduleKey = 'cms_blogs';
    protected $object_type = 'cms_blogs';
    ...
    /**
     * Lists all CmsBlogs models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CmsBlogsSearch();
        ...
        if (Yii::$app->request->post('hasEditable')) {
            ...
            $model = CmsBlogs::findOne($Id);

            $out = Json::encode(['output' => '', 'message' => '']);

            $post = [];
            $posted = current($_POST['CmsBlogs']);
            $post['CmsBlogs'] = $posted;
    ...
    /**
     * Displays a single CmsBlogs model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing CmsBlogs model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsBlogs model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing CmsBlogs model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the CmsBlogs model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return CmsBlogs the loaded model
