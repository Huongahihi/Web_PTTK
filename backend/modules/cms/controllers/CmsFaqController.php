...
* This is the customized model class for table "CmsFaq".
*/
namespace backend\modules\cms\controllers;

use Yii;
use backend\modules\cms\models\CmsFaq;
use backend\modules\cms\models\CmsFaqSearch;
 ...
 */
class CmsFaqController extends AdminController
{
    protected $moduleName = 'CmsFaq';
    protected $moduleTitle = 'Cms Faq';
    protected $moduleKey = 'cms_faq';
    protected $object_type = 'cms_faq';
...
/**
    ...
    {    
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsFaq::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsFaq']);
           $post['CmsFaq'] = $posted;
    ...
    /**
     * Delete an existing CmsFaq model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsFaq model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
