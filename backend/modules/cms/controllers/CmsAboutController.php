...
use backend\modules\cms\models\CmsAboutSearch;
...
/**
 * CmsAboutController implements the CRUD actions for CmsAbout model.
 */
class CmsAboutController extends AdminController
{
    protected $moduleName = 'CmsAbout';
    protected $moduleTitle = 'Cms About';
    protected $moduleKey = 'cms_about';
    protected $object_type = 'cms_about';
...
/**
    ...
    {    
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsAbout::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsAbout']);
           $post['CmsAbout'] = $posted;
    ...
    /**
     * Delete an existing CmsAbout model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsAbout model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the CmsAbout model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return CmsAbout the loaded model
