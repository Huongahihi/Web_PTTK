...
{
    protected $moduleName = 'CmsPage';
    protected $moduleTitle = 'Cms Page';
    protected $moduleKey = 'cms_page';
    protected $object_type = 'cms_page';
...
/**
    ...
    /**
     * Delete an existing CmsPage model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsPage model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
