...
use backend\modules\cms\models\CmsTestimonialSearch;
...
/**
 * CmsTestimonialController implements the CRUD actions for CmsTestimonial model.
 */
class CmsTestimonialController extends AdminController
{
    protected $moduleName = 'CmsTestimonial';
    protected $moduleTitle = 'Cms Testimonial';
    protected $moduleKey = 'cms_testimonial';
    protected $object_type = 'cms_testimonial';
...
/**
    ...
    /**
     * Lists all CmsTestimonial models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CmsTestimonialSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsTestimonial::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsTestimonial']);
           $post['CmsTestimonial'] = $posted;
    ...
    /**
     * Displays a single CmsTestimonial model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CmsTestimonial model.
    ...
    /**
     * Updates an existing CmsTestimonial model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsTestimonial model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsTestimonial model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CmsTestimonial model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CmsTestimonial the loaded model
