...
use backend\modules\cms\models\CmsPortfolioSearch;
...
/**
 * CmsPortfolioController implements the CRUD actions for CmsPortfolio model.
 */
class CmsPortfolioController extends AdminController
{
    protected $moduleName = 'CmsPortfolio';
    protected $moduleTitle = 'Cms Portfolio';
    protected $moduleKey = 'cms_portfolio';
    protected $object_type = 'cms_portfolio';
...
/**
    ...
    /**
     * Lists all CmsPortfolio models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CmsPortfolioSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsPortfolio::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsPortfolio']);
           $post['CmsPortfolio'] = $posted;
    ...
    /**
     * Displays a single CmsPortfolio model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CmsPortfolio model.
    ...
    /**
     * Updates an existing CmsPortfolio model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsPortfolio model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsPortfolio model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CmsPortfolio model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CmsPortfolio the loaded model
