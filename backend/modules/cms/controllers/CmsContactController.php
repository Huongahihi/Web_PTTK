...
use backend\modules\cms\models\CmsContactSearch;
...
/**
 * CmsContactController implements the CRUD actions for CmsContact model.
 */
class CmsContactController extends AdminController
{
    protected $moduleName = 'CmsContact';
    protected $moduleTitle = 'Cms Contact';
    protected $moduleKey = 'cms_contact';
    protected $object_type = 'cms_contact';
...
/**
    ...
    /**
     * Lists all CmsContact models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CmsContactSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsContact::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsContact']);
           $post['CmsContact'] = $posted;
    ...
    /**
     * Displays a single CmsContact model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CmsContact model.
    ...
    /**
     * Updates an existing CmsContact model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsContact model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsContact model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CmsContact model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CmsContact the loaded model
