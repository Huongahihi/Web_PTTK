...
use backend\modules\cms\models\CmsAlbumSearch;
 ...
 */
class CmsAlbumController extends AdminController
{
    protected $moduleName = 'CmsAlbum';
    protected $moduleTitle = 'Cms Album';
    protected $moduleKey = 'cms_album';
    protected $object_type = 'cms_album';
...
/**
    ...
    {    
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $post = [];
           $posted = current($_POST['CmsAlbum']);
           $post['CmsAlbum'] = $posted;
    ...
    /**
     * Delete an existing CmsAlbum model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsAlbum model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
