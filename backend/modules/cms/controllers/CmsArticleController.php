...
use backend\modules\cms\models\CmsArticleSearch;
...
{
    protected $moduleName = 'CmsArticle';
    protected $moduleTitle = 'Cms Article';
    protected $moduleKey = 'cms_article';
    protected $object_type = 'cms_article';
...
/**
    ...
    {    
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $post = [];
           $posted = current($_POST['CmsArticle']);
           $post['CmsArticle'] = $posted;
    ...
    /**
     * Delete an existing CmsArticle model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsArticle model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
