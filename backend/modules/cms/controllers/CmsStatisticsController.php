...
use backend\modules\cms\models\CmsStatisticsSearch;
...
/**
 * CmsStatisticsController implements the CRUD actions for CmsStatistics model.
 */
class CmsStatisticsController extends AdminController
{
    protected $moduleName = 'CmsStatistics';
    protected $moduleTitle = 'Cms Statistics';
    protected $moduleKey = 'cms_statistics';
    protected $object_type = 'cms_statistics';
...
/**
    ...
    /**
     * Lists all CmsStatistics models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CmsStatisticsSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsStatistics::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsStatistics']);
           $post['CmsStatistics'] = $posted;
    ...
    /**
     * Displays a single CmsStatistics model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CmsStatistics model.
    ...
    /**
     * Updates an existing CmsStatistics model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsStatistics model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsStatistics model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CmsStatistics model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CmsStatistics the loaded model
