...
use backend\modules\cms\models\CmsEmployeeSearch;
...
/**
 * CmsEmployeeController implements the CRUD actions for CmsEmployee model.
 */
class CmsEmployeeController extends AdminController
{
    protected $moduleName = 'CmsEmployee';
    protected $moduleTitle = 'Cms Employee';
    protected $moduleKey = 'cms_employee';
    protected $object_type = 'cms_employee';
...
/**
    ...
    /**
     * Lists all CmsEmployee models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CmsEmployeeSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CmsEmployee::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CmsEmployee']);
           $post['CmsEmployee'] = $posted;
    ...
    /**
     * Displays a single CmsEmployee model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CmsEmployee model.
    ...
    /**
     * Updates an existing CmsEmployee model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CmsEmployee model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CmsEmployee model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CmsEmployee model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CmsEmployee the loaded model
