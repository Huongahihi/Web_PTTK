...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'rate')->rate() ?>

       <?= $form->field($model, 'score')->numeric() ?>

       <?= $form->field($model, 'budget')->textInput() ?>

       <?= $form->field($model, 'default_duration')->select(FHtml::getComboArray('travel_attractions', 'travel_attractions', 'default_duration', true, 'id', 'name')) ?>
       ...
       <?= $form->field($model, 'close')->textInput() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'category_id_array')->select(FHtml::getComboArray('travel_attractions', 'travel_attractions', 'category_id', true, 'id', 'name'))->labelSpan(6) ?>
       ...
       <?= $form->field($model, 'lat')->money() ?>

       <?= $form->field($model, 'long')->money() ?>
       ...
       <?= $form->field($model, 'country')->textInput() ?>
                                                                                               ...
                                                                                               <?= FHtml::showGroupHeader('More') ?>
                                                   <?= $form->field($model, 'type')->select(FHtml::getComboArray('travel_attractions', 'travel_attractions', 'type', true, 'id', 'name')) ?>

       <?= $form->field($model, 'status')->select(FHtml::getComboArray('travel_attractions', 'travel_attractions', 'status', true, 'id', 'name')) ?>
