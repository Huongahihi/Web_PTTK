    ...
    <div class="row">
        <div class="profile-sidebar col-md-3">
            <div class="portlet light">
                ...
                <div class="margin-top-20">
                    <?= FHtml::showLabel('travel_attractions.type', 'travel_attractions', 'type', $model->type) ?>
                    <?= FHtml::showLabel('travel_attractions.status', 'travel_attractions', 'status', $model->status) ?>
                </div>
            ...
            <div class="portlet light">
                <div class="portlet-title tabbable-line">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#tab_1_5" data-toggle="tab"><?= FHtml::t('common', 'TIPS') ?></a>
                        </li>
                        <li>
                            <a href="#tab_1_6" data-toggle="tab"><?= FHtml::t('common', 'CONTACT') ?></a>
                        </li>
                        <li>
                            <a href="#tab_1_7" data-toggle="tab"><?= FHtml::t('common', 'Location') ?></a>
                        </li>
                        <li>
                            <a href="#tab_1_8" data-toggle="tab"><?= FHtml::t('common', 'Sort') ?></a>
                        </li>
                        <li>
                            <a href="#tab_1_9" data-toggle="tab"><?= FHtml::t('common', 'Category') ?></a>
                        </li>
                        <li>
                            <a href="#tab_1_10" data-toggle="tab"><?= FHtml::t('common', 'GROUP') ?></a>
                        </li>
                        <li>
                            <a href="#tab_1_11" data-toggle="tab"><?= FHtml::t('common', 'Application') ?></a>
                        </li>
                    </ul>
                </div>
                <div class="body">
                    <div class="form">
                        <div class="form-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane row" id="tab_1_11">
                                    <div class="col-md-12">
                                    </div>
                                </div>
