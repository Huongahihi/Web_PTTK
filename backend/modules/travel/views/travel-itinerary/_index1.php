...
/* @var $searchModel backend\modules\travel\models\TravelItinerarySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$moduleName = isset($moduleName) ? $moduleName : 'TravelItinerary';
$moduleTitle = isset($moduleTitle) ? $moduleTitle : 'Travel Itinerary';
$moduleKey = isset($moduleKey) ? $moduleKey : 'travel-itinerary';
$object_type = isset($object_type) ? $object_type : 'travel_itinerary';
...
<div class="row">
    ...
    <div class="col-md-10 col-xs-12">
        <div class="travel-itinerary-index">
