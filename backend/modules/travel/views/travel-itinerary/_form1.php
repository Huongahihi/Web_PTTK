...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'user_id')->select(FHtml::getComboArray('@user', 'user', 'user_id', true, 'id', 'name')) ?>
       ...
       <?= $form->field($model, 'days')->numeric() ?>

       <?= $form->field($model, 'city')->select(FHtml::getComboArray('travel_itinerary', 'travel_itinerary', 'city', true, 'id', 'name')) ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'status')->select(FHtml::getComboArray('travel_itinerary', 'travel_itinerary', 'status', true, 'id', 'name'))->labelSpan(6) ?>

                                            </div>
                                            <div class="col-md-6">
                                                       <?= $form->field($model, 'is_top')->checkbox() ->labelSpan(6) ?>

       <?= $form->field($model, 'is_system')->checkbox() ->labelSpan(6) ?>
