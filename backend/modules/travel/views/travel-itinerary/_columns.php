...
/*
    ...
    [ //name: days, dbType: int(10), phpType: integer, size: 10, allowNull: 1 
        'class' => FHtml::getColumnClass($object_type, 'days', $form_type),
        'format'=>'raw', //['decimal', 0],
        'attribute'=>'days',
        'visible' => FHtml::isVisibleInGrid($object_type, 'days', $form_type),
    ...
    [ //name: image_size, dbType: varchar(255), phpType: string, size: 255, allowNull: 1 
        'class' => FHtml::getColumnClass($object_type, 'image_size', $form_type),
        'format'=>'raw',
        'attribute'=>'image_size',
        'visible' => FHtml::isVisibleInGrid($object_type, 'image_size', $form_type),
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'contentOptions'=>['class'=>'col-md-1 nowrap'],
        'editableOptions'=>[                       
    ...
    [ //name: is_top, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_top, FHtml::SHOW_BOOLEAN, 'travel_itinerary', 'is_top','tinyint(1)','travel-itinerary'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
    [ //name: is_system, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'format'=>'raw',
        'attribute'=>'is_system',
        'visible' => FHtml::isVisibleInGrid($object_type, 'is_system', $form_type),
    ...
    //[ //name: sort_order, dbType: int(5), phpType: integer, size: 5, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> sort_order, FHtml::SHOW_NUMBER, 'travel_itinerary', 'sort_order','int(5)','travel-itinerary'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
