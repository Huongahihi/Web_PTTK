        ...
        <div class="col-md-9">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        <?= FHtml::showModelField($model, 'search_result', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'travel_sites', 'search_element', 'varchar(255)', '', '') ?>

                                        <?= FHtml::showModelField($model, 'search_content', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'travel_sites', 'search_element', 'varchar(255)', '', '') ?>
            ...
            <?php } else { ?>
                <p class="hidden-print">
                    ...
                    <?php if ($canEdit) {
                        echo FHtml::a('<i class="fa fa-pencil"></i> ' . FHtml::t('common', 'Update'), ['update', 'id' => $model->id], ['class' => 'btn btn-warning']);
                    } ?>
                    <?php if ($canDelete) {
                        echo FHtml::a('<i class="fa fa-trash"></i> ' . FHtml::t('common', 'Delete'), ['delete', 'id' => $model->id], [
                    ...
                    <?= FHtml::a('<i class="fa fa-undo"></i> ' . FHtml::t('common', 'Cancel'), ['index', 'city' => $model->city, 'keywords' => $model->keywords], ['class' => 'btn btn-default']) ?>
