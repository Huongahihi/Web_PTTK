 ...
 * This is the customized model class for table "backend\modules\travel\models\TravelAttractions".
 */
class TravelAttractionsAction extends BaseAction
{
    public function run()
    {
        $this->listname = 'travel_attractions';
        $this->objectname = 'travel_attractions';
