...
* This is the customized model class for table "backend\modules\travel\models\TravelSites".
*/
class TravelSitesAction extends BaseAction
{
    public function run()
    {
        $this->listname = 'travel_sites';
        $this->objectname = 'travel_sites';
