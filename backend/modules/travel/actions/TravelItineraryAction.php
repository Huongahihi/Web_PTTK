...
* This is the customized model class for table "backend\modules\travel\models\TravelItinerary".
*/
class TravelItineraryAction extends BaseAction
{
    public function run()
    {
        $this->listname = 'travel_itinerary';
        $this->objectname = 'travel_itinerary';
