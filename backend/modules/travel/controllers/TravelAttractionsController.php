...
use backend\modules\travel\models\TravelAttractionsSearch;
...
/**
 * TravelAttractionsController implements the CRUD actions for TravelAttractions model.
 */
class TravelAttractionsController extends AdminController
{
    protected $moduleName = 'TravelAttractions';
    protected $moduleTitle = 'Travel Attractions';
    protected $moduleKey = 'travel_attractions';
    protected $object_type = 'travel_attractions';
...
/**
    ...
    /**
     * Lists all TravelAttractions models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new TravelAttractionsSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = TravelAttractions::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['TravelAttractions']);
           $post['TravelAttractions'] = $posted;
    ...
    /**
     * Displays a single TravelAttractions model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TravelAttractions model.
    ...
    /**
     * Updates an existing TravelAttractions model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing TravelAttractions model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TravelAttractions model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the TravelAttractions model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return TravelAttractions the loaded model
