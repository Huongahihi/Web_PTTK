...
use backend\modules\travel\models\TravelItinerarySearch;
...
/**
 * TravelItineraryController implements the CRUD actions for TravelItinerary model.
 */
class TravelItineraryController extends AdminController
{
    protected $moduleName = 'TravelItinerary';
    protected $moduleTitle = 'Travel Itinerary';
    protected $moduleKey = 'travel_itinerary';
    protected $object_type = 'travel_itinerary';
...
/**
    ...
    /**
     * Lists all TravelItinerary models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new TravelItinerarySearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $post = [];
           $posted = current($_POST['TravelItinerary']);
           $post['TravelItinerary'] = $posted;
    ...
    /**
     * Displays a single TravelItinerary model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TravelItinerary model.
    ...
    /**
     * Updates an existing TravelItinerary model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing TravelItinerary model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TravelItinerary model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the TravelItinerary model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return TravelItinerary the loaded model
