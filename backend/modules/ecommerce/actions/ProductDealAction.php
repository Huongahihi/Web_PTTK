...
* This is the customized model class for table "backend\modules\ecommerce\models\ProductDeal".
*/
class ProductDealAction extends BaseAction
{
    public function run()
    {
        $this->listname = 'product_deal';
        $this->objectname = 'product_deal';
