...
* This is the customized model class for table "backend\modules\ecommerce\models\ProductBook".
*/
class ProductBookAction extends BaseAction
{
    public function run()
    {
        $this->listname = 'product_book';
        $this->objectname = 'product_book';
