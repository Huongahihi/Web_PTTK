...
* This is the customized model class for table "backend\modules\ecommerce\models\ProductCourse".
*/
class ProductCourseAction extends BaseAction
{
    public function run()
    {
        $this->listname = 'product_course';
        $this->objectname = 'product_course';
