...
namespace backend\modules\ecommerce\actions;
...
* This is the customized model class for table "backend\modules\ecommerce\models\ProductClothes".
*/
class ProductClothesAction extends BaseAction
{
    public function run()
    {
        $this->listname = 'product_clothes';
        $this->objectname = 'product_clothes';
