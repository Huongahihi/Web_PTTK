                                ...
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        <?php echo FFormTable::widget(['model' => $model, 'form' => $form, 'columns' => 1, 'attributes' => [
                                            ...
                                            'unit' => ['value' => $form->fieldNoLabel($model, 'unit')->select(FHtml::getComboArray('product', 'product', 'unit', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            ...
                                            'brand_id' => ['value' => $form->fieldNoLabel($model, 'brand_id')->select(FHtml::getComboArray('@provider', 'provider', 'brand_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'promotion_id' => ['value' => $form->fieldNoLabel($model, 'promotion_id')->select(FHtml::getComboArray('@promotion', 'promotion', 'promotion_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'quantity' => ['value' => $form->fieldNoLabel($model, 'quantity')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'discount' => ['value' => $form->fieldNoLabel($model, 'discount')->slide(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'tax' => ['value' => $form->fieldNoLabel($model, 'tax')->select(FHtml::getComboArray('product', 'product', 'tax', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'Pricing', 'form' => $form, 'columns' => 1, 'attributes' => [
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'Group', 'form' => $form, 'columns' => 2, 'attributes' => [
                                            ...
                                            'type' => ['value' => $form->fieldNoLabel($model, 'type')->select(FHtml::getComboArray('product', 'product', 'type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'status' => ['value' => $form->fieldNoLabel($model, 'status')->select(FHtml::getComboArray('product', 'product', 'status', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'category_id' => ['value' => $form->fieldNoLabel($model, 'category_id_array')->selectMany(FHtml::getComboArray('product', 'product', 'category_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'count', 'form' => $form, 'columns' => 1, 'attributes' => [
                                ...
                                <div class="tab-pane row" id="tab_1_2">
                                    <div class="col-md-12">
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => '', 'form' => $form, 'columns' => 1, 'attributes' => [
                                            ...
                                            'qrcode_image' => ['value' => $form->fieldNoLabel($model, 'qrcode_image')->image(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'barcode_image' => ['value' => $form->fieldNoLabel($model, 'barcode_image')->image(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
