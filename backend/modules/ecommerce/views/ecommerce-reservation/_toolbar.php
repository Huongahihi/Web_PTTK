...
$moduleKey = 'ecommerce_reservation';
...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    [FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('EcommerceReservation', 'Payment Status') . ']:', 'ecommerce_reservation', 'ecommerce_reservation', 'payment_status')],
[FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('EcommerceReservation', 'Status') . ']:', 'ecommerce_reservation', 'ecommerce_reservation', 'status')],
[FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('EcommerceReservation', 'Is Active') . ']:', 'ecommerce_reservation', 'ecommerce_reservation', 'is_active')],
