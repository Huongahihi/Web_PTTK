...
<div class="row">
    <div class="col-md-2">
        <?= FHtml::buildGridFiltersVertical($object_type, ['category_id', 'type', 'status', 'lang', 'is_hot', 'is_top', 'is_active']) ?>    </div>
    <div class="col-md-10">
        <div class="ecommerce-order-index">
                    ...
                    <?php  endif; ?>                    <div class="row">
                        <div class="col-md-12">
                            <div id="ajaxCrudDatatable"
                                 class="<?php if (!$this->params['displayPortlet']) echo 'portlet light';  ?>">
                                <?=FGridView::widget([
                                'id'=>'crud-datatable',
