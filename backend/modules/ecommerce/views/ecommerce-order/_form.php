                            ...
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'Shipping', 'form' => $form, 'columns' => 1, 'attributes' => [

                                            'shipping_address' => ['type' => FHtml::INPUT_RAW, 'value' => $form->fieldNoLabel($model, 'shipping_address')->textInput(), 'columnOptions' => ['colspan' => 1]],
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'Order', 'form' => $form, 'columns' => 1, 'attributes' => [
                                            ...
                                            'order_date' => ['type' => FHtml::INPUT_RAW, 'value' => $form->fieldNoLabel($model, 'order_date')->date(), 'columnOptions' => ['colspan' => 1]],
                                            'order_detail' => ['type' => FHtml::INPUT_RAW, 'value' => $form->fieldNoLabel($model, 'order_detail')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1]],
                                            'order_note' => ['type' => FHtml::INPUT_RAW, 'value' => $form->fieldNoLabel($model, 'order_note')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1]],
                                            'promotion_code' => ['type' => FHtml::INPUT_RAW, 'value' => $form->fieldNoLabel($model, 'promotion_code')->textInput(), 'columnOptions' => ['colspan' => 1]],
                                            'tax' => ['type' => FHtml::INPUT_RAW, 'value' => $form->fieldNoLabel($model, 'tax')->selectMany(FHtml::getComboArray('ecommerce_order', 'ecommerce_order', 'tax', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1]],
                                            'order_type' => ['type' => FHtml::INPUT_RAW, 'value' => $form->fieldNoLabel($model, 'order_type')->select(FHtml::getComboArray('ecommerce_order', 'ecommerce_order', 'order_type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1]],
