...
<div class="form">
    <div class="row">
                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                               <?= $form->field($model, 'user_id')->select(FHtml::getComboArray('ecommerce_order', 'ecommerce_order', 'user_id', true, 'id', 'name')) ?>
       ...
       <?= $form->field($model, 'billing_email')->emailInput() ?>
       ...
       <?= $form->field($model, 'billing_country')->textInput() ?>
                                        ...
                                        -->
                                                   ...
                                                   <?= $form->field($model, 'shipping_address')->textInput() ?>
                                                                                               ...
                                                                                               <?= FHtml::showGroupHeader('More') ?>
                                                   <?= $form->field($model, 'order_date')->date() ?>
       ...
       <?= $form->field($model, 'tax')->selectMany(FHtml::getComboArray('ecommerce_order', 'ecommerce_order', 'tax', true, 'id', 'name')) ?>

       <?= $form->field($model, 'order_type')->select(FHtml::getComboArray('ecommerce_order', 'ecommerce_order', 'order_type', true, 'id', 'name')) ?>

       <?= $form->field($model, 'order_status')->select(FHtml::getComboArray('ecommerce_order', 'ecommerce_order', 'order_status', true, 'id', 'name')) ?>
       ...
       <?= $form->field($model, 'is_active')->checkbox()  ?>
                                                                                               ...
                                                                                               <?= FHtml::showGroupHeader('More') ?>
                                                   <?= $form->field($model, 'price_total')->currency() ?>

       <?= $form->field($model, 'price_shipping')->currency() ?>

       <?= $form->field($model, 'price_tax')->currency() ?>

       <?= $form->field($model, 'price_discount')->currency() ?>

       <?= $form->field($model, 'price_final')->money() ?>

       <?= $form->field($model, 'payment_method')->select(FHtml::getComboArray('ecommerce_order', 'ecommerce_order', 'payment_method', true, 'id', 'name')) ?>

       <?= $form->field($model, 'payment_status')->select(FHtml::getComboArray('ecommerce_order', 'ecommerce_order', 'payment_status', true, 'id', 'name')) ?>
