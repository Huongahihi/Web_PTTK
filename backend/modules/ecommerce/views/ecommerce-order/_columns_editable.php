...
return [
    ...
    [ //name: user_id, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> user_id, FHtml::SHOW_LOOKUP, '@user', 'user_id','varchar(100)','ecommerce-order'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
    ...
    [ //name: shipping_address, dbType: varchar(2000), phpType: string, size: 2000, allowNull: 1 
    ...
    //[ //name: shipping_time, dbType: varchar(255), phpType: string, size: 255, allowNull: 1 
        //'class' => FHtml::getColumnClass($moduleName, 'shipping_time', $form_type, true),
        //'format'=>'raw',
        //'attribute'=>'shipping_time',
        //'visible' => FHtml::isVisibleInGrid($moduleName, 'shipping_time', $form_type, true),
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'contentOptions'=>['class'=>'col-md-1 nowrap'],
        //'editableOptions'=>[                       
                        ...
                        //],
    //],
    //[ //name: shipping_note, dbType: varchar(2000), phpType: string, size: 2000, allowNull: 1 
        //'class' => FHtml::getColumnClass($moduleName, 'shipping_note', $form_type, true),
        //'format'=>'raw',
        //'attribute'=>'shipping_note',
        //'visible' => FHtml::isVisibleInGrid($moduleName, 'shipping_note', $form_type, true),
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'contentOptions'=>['class'=>'col-md-2 nowrap'],
        //'editableOptions'=>[                       
