                                ...
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'Group', 'form' => $form, 'columns' => 2, 'attributes' => [
                                            ...
                                            'discount_type' => ['value' => $form->fieldNoLabel($model, 'discount_type')->select(FHtml::getComboArray('promotion', 'promotion', 'discount_type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'apply_type' => ['value' => $form->fieldNoLabel($model, 'apply_type')->select(FHtml::getComboArray('promotion', 'promotion', 'apply_type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'Usage', 'form' => $form, 'columns' => 1, 'attributes' => [

                                            'usage_limit' => ['value' => $form->fieldNoLabel($model, 'usage_limit')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'usage_current' => ['value' => $form->fieldNoLabel($model, 'usage_current')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],


                                        ]]); ?>

                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'Apply', 'form' => $form, 'columns' => 1, 'attributes' => [

                                            'sales_over' => ['value' => $form->fieldNoLabel($model, 'sales_over')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                            'products' => ['value' => $form->fieldNoLabel($model, 'products')->selectMany(FHtml::getComboArray('@product', 'product', 'products', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],


                                        ]]); ?>

                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'Duration', 'form' => $form, 'columns' => 1, 'attributes' => [
                                        ...
                                        <?php echo FFormTable::widget(['model' => $model, 'title' => 'count', 'form' => $form, 'columns' => 1, 'attributes' => [
                                            ...
                                            'count_shares' => ['value' => $form->fieldNoLabel($model, 'count_shares')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
