...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'promotion', 'promotion', 'discount_type'),
FHtml::buildBulkActionsMenu('', 'promotion', 'promotion', 'apply_type'),
FHtml::buildBulkActionsMenu('', 'promotion', 'promotion', 'is_top'),
FHtml::buildBulkActionsMenu('', 'promotion', 'promotion', 'is_active'),
