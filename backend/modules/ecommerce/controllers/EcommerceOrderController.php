...
use backend\modules\ecommerce\models\EcommerceOrderSearch;
...
/**
 * EcommerceOrderController implements the CRUD actions for EcommerceOrder model.
 */
class EcommerceOrderController extends AdminController
{
    protected $moduleName = 'EcommerceOrder';
    protected $moduleTitle = 'Ecommerce Order';
    protected $moduleKey = 'ecommerce_order';
    protected $object_type = 'ecommerce_order';
...
/**
    ...
    /**
     * Lists all EcommerceOrder models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new EcommerceOrderSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
           ...
           if (Yii::$app->request->post('hasEditable')) {
               ...
               $model = EcommerceOrder::findOne($Id);
               ...
               $post = [];
               $posted = current($_POST['EcommerceOrder']);
               $post['EcommerceOrder'] = $posted;
    ...
    /**
     * Displays a single EcommerceOrder model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new EcommerceOrder model.
    ...
    public function actionCreate($type = false)
    {
        ...
        $uploadFields = EcommerceOrder::COLUMNS_UPLOAD;
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                'title'=> FHtml::t($this->moduleName),
                'content'=>'<span class="text-success">Create EcommerceOrder success</span>',
                'footer'=> Html::button(FHtml::t('Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            ...
            if ($model->load($request->post())) {
                ...
                if ($model->save()) {
                    ...
                    FHtml::addMessage(Fhtml::t('common', 'Saved successfully'));

                    FHtml::saveModel($modelMeta, $request->post(), ['ecommerce_order_id' => $model->id]);
    ...
    /**
     * Updates an existing EcommerceOrder model.
     * For ajax request will return json object
        ...
        if($request->isAjax){
            ...
            */
            ...
            if ($model->load($request->post())) {
                ...
                $files =FHtml::getUploadedFiles($model, $uploadFields, 'ecommerce-order' . FHtml::getAttribute($model, 'id'), $oldModel);
    ...
    /**
     * Delete an existing EcommerceOrder model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing EcommerceOrder model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the EcommerceOrder model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return EcommerceOrder the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = EcommerceOrder::findOne($id)) !== null) {
            return $model;
        } else {
