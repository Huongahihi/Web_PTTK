...
{
    protected $moduleName = 'Promotion';
    protected $moduleTitle = 'Promotion';
    protected $moduleKey = 'promotion';
    protected $object_type = 'promotion';
...
/**
    ...
    {    
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $post = [];
           $posted = current($_POST['Promotion']);
           $post['Promotion'] = $posted;
    ...
    /**
     * Delete an existing Promotion model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Promotion model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
