...
use backend\modules\ecommerce\models\ProviderSearch;
...
class ProviderController extends AdminController
{
    ...
    protected $moduleTitle = 'Provider';
    protected $moduleKey = 'provider';
...
/**
    ...
    /**
     * Delete an existing Provider model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Provider model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
