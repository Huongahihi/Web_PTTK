...
use backend\modules\ecommerce\models\EcommerceReservationSearch;
...
/**
 * EcommerceReservationController implements the CRUD actions for EcommerceReservation model.
 */
class EcommerceReservationController extends AdminController
{
    protected $moduleName = 'EcommerceReservation';
    protected $moduleTitle = 'Ecommerce Reservation';
    protected $moduleKey = 'ecommerce_reservation';
...
/**
    ...
    /**
     * Lists all EcommerceReservation models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new EcommerceReservationSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
           ...
           if (Yii::$app->request->post('hasEditable')) {
               ...
               $model = EcommerceReservation::findOne($Id);
               ...
               $post = [];
               $posted = current($_POST['EcommerceReservation']);
               $post['EcommerceReservation'] = $posted;
    ...
    /**
     * Displays a single EcommerceReservation model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new EcommerceReservation model.
    ...
    public function actionCreate($type = false)
    {
        ...
        $uploadFields = EcommerceReservation::COLUMNS_UPLOAD;
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                'title'=> FHtml::t($this->moduleName),
                'content'=>'<span class="text-success">Create EcommerceReservation success</span>',
                'footer'=> Html::button(FHtml::t('Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing EcommerceReservation model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing EcommerceReservation model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing EcommerceReservation model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the EcommerceReservation model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return EcommerceReservation the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = EcommerceReservation::findOne($id)) !== null) {
            return $model;
        } else {
