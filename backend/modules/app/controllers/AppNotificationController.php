...
use Yii;
use backend\modules\app\models\AppNotification;
use backend\modules\app\models\AppNotificationSearch;
...
/**
 * AppNotificationController implements the CRUD actions for AppNotification model.
 */
class AppNotificationController extends AdminController
{
    protected $moduleName = 'AppNotification';
    protected $moduleTitle = 'App Notification';
...
/**
    ...
    /**
     * Lists all AppNotification models.
     * @return mixed
     */
    ...
    /**
     * Displays a single AppNotification model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new AppNotification model.
    ...
    public function actionCreate($type = false)
    {
        ...
        if($request->isAjax){
            ...
            if ($model->load($request->post())) {
                ...
                FApi::executeNotification($model);
    ...
    /**
     * Updates an existing AppNotification model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing AppNotification model.
     * For ajax request will return json object
    ...
    /**
     * Finds the AppNotification model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return AppNotification the loaded model
