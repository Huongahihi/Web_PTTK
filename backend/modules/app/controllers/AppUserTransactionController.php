...
use backend\modules\app\models\AppUserTransactionSearch;
...
/**
 * AppUserTransactionController implements the CRUD actions for AppUserTransaction model.
 */
class AppUserTransactionController extends AdminController
{
    protected $moduleName = 'AppUserTransaction';
    protected $moduleTitle = 'App User Transaction';
    protected $moduleKey = 'app_user_transaction';
...
/**
    ...
    /**
     * Lists all AppUserTransaction models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new AppUserTransactionSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
           ...
           if (Yii::$app->request->post('hasEditable')) {
               ...
               $model = AppUserTransaction::findOne($Id);
               ...
               $post = [];
               $posted = current($_POST['AppUserTransaction']);
               $post['AppUserTransaction'] = $posted;
    ...
    /**
     * Displays a single AppUserTransaction model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new AppUserTransaction model.
    ...
    public function actionCreate($type = false)
    {
        ...
        $uploadFields = AppUserTransaction::COLUMNS_UPLOAD;
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                'title'=> FHtml::t($this->moduleName),
                'content'=>'<span class="text-success">Create AppUserTransaction success</span>',
                'footer'=> Html::button(FHtml::t('Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing AppUserTransaction model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing AppUserTransaction model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing AppUserTransaction model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the AppUserTransaction model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return AppUserTransaction the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AppUserTransaction::findOne($id)) !== null) {
            return $model;
        } else {
