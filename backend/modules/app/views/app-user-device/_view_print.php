    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <div class="portlet light">
                ...
                <?= ($field_layout == FHtml::LAYOUT_TABLE) ? '<table class="table table-bordered">' : '' ?>                       <?= FHtml::showModelField($model, 'id', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'app_user_device', 'id', 'int(11)', '', '') ?>

                <?= FHtml::showModelField($model, 'ime', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'app_user_device', 'ime', 'varchar(255)', '', '') ?>

                <?= FHtml::showModelField($model, 'type', FHtml::SHOW_ACTIVE, $field_layout, $form_label_CSS, 'app_user_device', 'type', 'tinyint(1)', '', '') ?>

                <?= FHtml::showModelField($model, 'status', FHtml::SHOW_ACTIVE, $field_layout, $form_label_CSS, 'app_user_device', 'status', 'tinyint(1)', '', '') ?>

                <?= FHtml::showModelField($model, 'user_id', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'app_user_device', 'user_id', 'int(11)', '', '') ?>

                <?= FHtml::showModelField($model, 'gcm_id', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'app_user_device', 'gcm_id', 'varchar(255)', '', '') ?>
