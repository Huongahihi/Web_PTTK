...
<?= FHtml::showLabel('app-user-transaction.status', 'app-user-transaction', 'status', $model->status) ?>
                ...
                <div class="portlet-title tabbable-line">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active">
                            ...
                            <li>
                                <a href="#tab_1_5" data-toggle="tab"><?= FHtml::t('common', 'Receiver')?></a>
                                </li>
                            <li>
                                <a href="#tab_1_6" data-toggle="tab"><?= FHtml::t('common', 'Object')?></a>
                                </li>
                            <li>
                                <a href="#tab_1_7" data-toggle="tab"><?= FHtml::t('common', 'Payment')?></a>
                                </li>
                            <li>
       ...
       <?= FHtml::showModelField($model,'action', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'app_user_transaction', 'action', 'varchar(255)', '', '') ?>
                                ...
                                -->                                                                        <div class="tab-pane row" id="tab_1_4">
                                            ...
                                            <div class="col-md-12">
                                                <?= ($field_layout == FHtml::LAYOUT_TABLE) ? '<table class="table table-bordered">' : '' ?>                                                       <?= FHtml::showModelField($model,'receiver_user_id', FHtml::SHOW_LOOKUP, $field_layout, $form_label_CSS, '@user', 'receiver_user_id', 'varchar(100)', '', '') ?>
