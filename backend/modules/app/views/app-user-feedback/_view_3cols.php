    ...
    <div class="row">
        ...
        <div class="profile-sidebar col-md-3 hidden-print">
            <div class="portlet light">
                ...
                <div class="margin-top-20">
                    <?= FHtml::showLabel('app-user-feedback.type', 'app-user-feedback', 'type', $model->type) ?>
<?= FHtml::showLabel('app-user-feedback.status', 'app-user-feedback', 'status', $model->status) ?>
                </div>
       ...
       <?= FHtml::showModelField($model,'object_id', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'app_user_feedback', 'object_id', 'varchar(100)', '', '') ?>
       ...
       <?= FHtml::showModelField($model,'response', FHtml::SHOW_HTML, $field_layout, $form_label_CSS, 'app_user_feedback', 'response', 'text', '', '') ?>
                ...
                <div class="">
                    <div class="tab-content">
                        <div class="tab-pane active row" id="tab_1_1">
                            <div class="col-md-12">
                                <?= ($field_layout == FHtml::LAYOUT_TABLE) ? '<table class="table table-bordered">' : '' ?>                                       <?= FHtml::showModelField($model,'object_type', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'app_user_feedback', 'object_type', 'varchar(100)', '', '') ?>

       <?= FHtml::showModelField($model,'type', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'app_user_feedback', 'type', 'varchar(100)', '', '') ?>

       <?= FHtml::showModelField($model,'status', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'app_user_feedback', 'status', 'varchar(100)', '', '') ?>
