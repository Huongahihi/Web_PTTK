    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <div class="portlet light">
                ...
                <?= ($field_layout == FHtml::LAYOUT_TABLE) ? '<table class="table table-bordered">' : '' ?>                       <?= FHtml::showModelField($model,'id', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'settings_lookup', 'id', 'int(11)', '', '') ?>

       <?= FHtml::showModelField($model,'name', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'settings_lookup', 'name', 'varchar(255)', '', '') ?>
       ...
       <?= FHtml::showModelField($model,'object_type', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'settings_lookup', 'object_type', 'varchar(100)', '', '') ?>

       <?= FHtml::showModelField($model,'is_cached', FHtml::SHOW_ACTIVE, $field_layout, $form_label_CSS, 'settings_lookup', 'is_cached', 'tinyint(1)', '', '') ?>
