            ...
            <div class="col-md-7">
                            ...
                            <div class="form-body">
                                <div class="tab-content">
                                    <div class="tab-pane active row" id="tab_1_1">
                                        <div class="col-md-12">
                                            <?= //name: parent_id, dbType: int(11), phpType: integer, size: 11, allowNull: 1
                                            $form->field($model, 'parent_id')->dropDownList(FHtml::getComboArray('object_category', 'object_category', 'parent_id', true, 'id', 'name'), ['prompt' => '']) ?>
                                            ...
                                            $form->field($model, 'description')->textarea(['rows' => 3]) ?>
                                            <?= //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull:
                                            $form->field($model, 'object_type')->textInput() ?>
                                            <?= //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull:
                                            $form->field($model, 'is_active')->widget(\kartik\widgets\SwitchInput::className(), []) ?>
                ...
                <div class="">
                    ...
                    <?php if (!$model->isNewRecord && $canDelete) { ?>
                        ...
                        <?= Html::a(FHtml::t('common', 'Cancel'), ['index', 'object_type' => $object_type], ['class' => 'btn btn-default']) ?>
                    <?php } else { ?>
                        <?= Html::a(FHtml::t('common', 'Cancel'), ['index', 'object_type' => $object_type], ['class' => 'btn btn-default']) ?>
                    <?php } ?>                            </div>
            </div>
