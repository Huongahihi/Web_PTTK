    ...
    <div class="row">
        <div class="profile-sidebar col-md-3 hidden-print">
            <div class="portlet light">
                                                <?= FHtml::showImage($model->icon, $modulePath, '50', 50)  ?>
       ...
       <?= FHtml::showModelField($model,'role', FHtml::SHOW_TEXT, $field_layout, $form_label_CSS, 'settings_menu', 'role', 'varchar(255)', '', '') ?>
                ...
                <div class="">
                    <div class="tab-content">
                        <div class="tab-pane active row" id="tab_1_1">
                            <div class="col-md-12">
                                <?= ($field_layout == FHtml::LAYOUT_TABLE) ? '<table class="table table-bordered">' : '' ?>                                       <?= FHtml::showModelField($model,'object_type', FHtml::SHOW_LABEL, $field_layout, $form_label_CSS, 'settings_menu', 'object_type', 'varchar(100)', '', '') ?>
