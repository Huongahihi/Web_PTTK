...
use backend\modules\system\models\SettingsLookupSearch;
...
/**
 * SettingsLookupController implements the CRUD actions for SettingsLookup model.
 */
class SettingsLookupController extends AdminController
{
    protected $moduleName = 'SettingsLookup';
    protected $moduleTitle = 'Settings Lookup';
    protected $moduleKey = 'settings_lookup';
...
/**
    ...
    /**
     * Lists all SettingsLookup models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new SettingsLookupSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
           ...
           if (Yii::$app->request->post('hasEditable')) {
               ...
               $model = SettingsLookup::findOne($Id);
               ...
               $post = [];
               $posted = current($_POST['SettingsLookup']);
               $post['SettingsLookup'] = $posted;
    ...
    /**
     * Displays a single SettingsLookup model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SettingsLookup model.
    ...
    public function actionCreate($type = false)
    {
        ...
        $uploadFields = SettingsLookup::COLUMNS_UPLOAD;
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                'title'=> FHtml::t($this->moduleName),
                'content'=>'<span class="text-success">Create SettingsLookup success</span>',
                'footer'=> Html::button(FHtml::t('Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing SettingsLookup model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing SettingsLookup model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing SettingsLookup model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the SettingsLookup model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SettingsLookup the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SettingsLookup::findOne($id)) !== null) {
            return $model;
        } else {
