...
use backend\modules\system\models\SettingsSchemaSearch;
...
/**
 * SettingsSchemaController implements the CRUD actions for SettingsSchema model.
 */
class SettingsSchemaController extends AdminController
{
    protected $moduleName = 'SettingsSchema';
    protected $moduleTitle = 'Settings Schema';
    protected $moduleKey = 'settings_schema';
...
/**
    ...
    /**
     * Lists all SettingsSchema models.
     * @return mixed
     */
    public function actionIndex()
    {

        $searchModel = new SettingsSchemaSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
           ...
           if (Yii::$app->request->post('hasEditable')) {
               ...
               $model = SettingsSchema::findOne($Id);
               ...
               $post = [];
               $posted = current($_POST['SettingsSchema']);
               $post['SettingsSchema'] = $posted;
    ...
    /**
     * Displays a single SettingsSchema model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SettingsSchema model.
    ...
    public function actionCreate($type = false)
    {
        ...
        $uploadFields = SettingsSchema::COLUMNS_UPLOAD;
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                'title'=> FHtml::t($this->moduleName),
                'content'=>'<span class="text-success">Create SettingsSchema success</span>',
                'footer'=> Html::button(FHtml::t('Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing SettingsSchema model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing SettingsSchema model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing SettingsSchema model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the SettingsSchema model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SettingsSchema the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SettingsSchema::findOne($id)) !== null) {
            return $model;
        } else {
