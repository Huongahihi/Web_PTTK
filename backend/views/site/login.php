...
<div class="row" style="height: 100%">
    <div class="col-md-8 col-xs-0"
         style="height:100%;background-repeat: no-repeat; background-position: center center; background-size: cover;background-image: url('<?= FHtml::getImageUrl(FHtml::settingAdminBackground()) ?>');">
        &nbsp;
    </div>
