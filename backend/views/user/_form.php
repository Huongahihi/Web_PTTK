...
$canEdit = FHtml::isInRole('', FHtml::currentAction(), $currentRole, FHtml::getFieldValue($model, ['id', 'user_id']));
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane row" id="tab_1_3">
                                    <div class="col-md-12">
                                        ...
                                        <?=  (FHtml::isRoleAdmin() || $model->id == FHtml::currentUserId() ) ? $form->field($model, 'password_new')->passwordInput(['readonly' => false])->hint('Reset New Password here') : '' ?>
