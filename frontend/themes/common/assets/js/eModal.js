...
function InitModal() {
    $('[data-toggle="modal"]').click(function (e) {
        ...
        var popup = $(this).attr('modal-type') || 'ajax';
        var title = $(this).attr('modal-title') || 'Information';
        var buttons = $(this).attr('modal-buttons') || 'Close';
...
;(function (define) {
    define(['jquery'], function ($, root) {
        ...
        function ajax(data, title) {
            ...
            function error(responseText/*, textStatus*/) {
                var msg = '<div class="alert alert-danger">' +
                    '<strong>XHR Fail: </strong>URL [ ' + params.url + '] load fail.' + responseText +
                    '</div>';
        ...
        function iframe(params, title) {
            ...
            '<iframe class="embed-responsive-item" frameborder=0 src="%0%" style="width:100%;height:85vh;display:block;"/>')
