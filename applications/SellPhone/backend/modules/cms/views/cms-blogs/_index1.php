...
/* @var $searchModel backend\modules\cms\models\CmsBlogsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$moduleName = isset($moduleName) ? $moduleName : 'CmsBlogs';
$moduleTitle = isset($moduleTitle) ? $moduleTitle : 'Cms Blogs';
$moduleKey = isset($moduleKey) ? $moduleKey : 'cms-blogs';
$object_type = isset($object_type) ? $object_type : 'cms_blogs';
...
<div class="row">
    ...
    <div class="col-md-2 col-xs-12">
        <?= FHtml::buildGridFiltersVertical($object_type, ['category_id', 'type', 'status', 'lang', 'is_hot', 'is_top']) ?>
    </div>
</div>
<?php Modal::begin([
    "id"=>"ajaxCrubModal",
