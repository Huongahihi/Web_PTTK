...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    [FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('CmsPartner', 'Is Top') . ']:', 'cms_partner', 'cms_partner', 'is_top')],
[FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('CmsPartner', 'Is Active') . ']:', 'cms_partner', 'cms_partner', 'is_active')],
