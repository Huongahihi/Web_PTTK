...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    [FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('CmsEmployee', 'Is Contact') . ']:', 'cms_employee', 'cms_employee', 'is_contact')],
[FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('CmsEmployee', 'Is Top') . ']:', 'cms_employee', 'cms_employee', 'is_top')],
[FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('CmsEmployee', 'Is Active') . ']:', 'cms_employee', 'cms_employee', 'is_active')],
