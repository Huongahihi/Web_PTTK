...
return [
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function ($model) {
            return '<b>' . FHtml::showContent($model->id, FHtml::SHOW_NUMBER, 'cms_employee', 'id', 'int(11)', 'cms-employee') . '</b>';
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: image, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showImageThumbnail($model->image, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'cms-employee');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '50px',
    ...
    [ //name: name, dbType: varchar(255), phpType: string, size: 255, allowNull:  
        ...
        'class' => FHtml::getColumnClass($object_type, 'position', $form_type),
        'format' => 'raw',
        'attribute' => 'position',
        'visible' => FHtml::isVisibleInGrid($object_type, 'position', $form_type),
        'hAlign' => 'left',
        'vAlign' => 'middle',
        'contentOptions' => ['class' => 'col-md-1 nowrap'],
        'editableOptions' => [
    ...
    [ //name: is_top, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_top, FHtml::SHOW_BOOLEAN, 'cms_employee', 'is_top', 'tinyint(1)', 'cms-employee');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '20px',
    ...
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull: 1 
        ...
        'value' => function ($model) {
            return FHtml::showContent($model->is_active, FHtml::SHOW_BOOLEAN, 'cms_employee', 'is_active', 'tinyint(1)', 'cms-employee');
        },
        'hAlign' => 'center',
        'vAlign' => 'middle',
        'width' => '20px',
