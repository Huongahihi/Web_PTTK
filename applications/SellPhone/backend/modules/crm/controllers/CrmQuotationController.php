...
use backend\modules\crm\models\CrmQuotationSearch;
...
/**
 * CrmQuotationController implements the CRUD actions for CrmQuotation model.
 */
class CrmQuotationController extends AdminController
{
    protected $moduleName = 'CrmQuotation';
    protected $moduleTitle = 'Crm Quotation';
    protected $moduleKey = 'crm_quotation';
    protected $object_type = 'crm_quotation';
...
/**
    ...
    /**
     * Lists all CrmQuotation models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CrmQuotationSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CrmQuotation::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CrmQuotation']);
           $post['CrmQuotation'] = $posted;
    ...
    /**
     * Displays a single CrmQuotation model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CrmQuotation model.
    ...
    /**
     * Updates an existing CrmQuotation model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CrmQuotation model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CrmQuotation model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the CrmQuotation model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return CrmQuotation the loaded model
