...
use backend\modules\crm\models\CrmClientSearch;
...
/**
 * CrmClientController implements the CRUD actions for CrmClient model.
 */
class CrmClientController extends AdminController
{
    protected $moduleName = 'CrmClient';
    protected $moduleTitle = 'Crm Client';
    protected $moduleKey = 'crm_client';
    protected $object_type = 'crm_client';
...
/**
    ...
    /**
     * Lists all CrmClient models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CrmClientSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CrmClient::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CrmClient']);
           $post['CrmClient'] = $posted;
    ...
    /**
     * Displays a single CrmClient model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing CrmClient model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CrmClient model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CrmClient model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the CrmClient model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return CrmClient the loaded model
