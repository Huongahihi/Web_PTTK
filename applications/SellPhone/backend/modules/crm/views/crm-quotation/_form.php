...
'request_date' => ['value' => $form->fieldNoLabel($model, 'request_date')->date(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'client_id' => ['value' => $form->fieldNoLabel($model, 'client_id')->select(FHtml::getComboArray('crm_quotation', 'crm_quotation', 'client_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'client_name' => ['value' => $form->fieldNoLabel($model, 'client_name')->textInput(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'client_description' => ['value' => $form->fieldNoLabel($model, 'client_description')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'client_requirement' => ['value' => $form->fieldNoLabel($model, 'client_requirement')->textarea(['rows' => 3]), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'expected_date' => ['value' => $form->fieldNoLabel($model, 'expected_date')->date(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'expired_date' => ['value' => $form->fieldNoLabel($model, 'expired_date')->date(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'completed_date' => ['value' => $form->fieldNoLabel($model, 'completed_date')->date(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'reason' => ['value' => $form->fieldNoLabel($model, 'reason')->html(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'note' => ['value' => $form->fieldNoLabel($model, 'note')->html(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'year' => ['value' => $form->fieldNoLabel($model, 'year')->numeric(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        -->
                                            ...
                                            'type' => ['value' => $form->fieldNoLabel($model, 'type')->select(FHtml::getComboArray('crm_quotation', 'crm_quotation', 'type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'status' => ['value' => $form->fieldNoLabel($model, 'status')->select(FHtml::getComboArray('crm_quotation', 'crm_quotation', 'status', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
