...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'request_date')->date() ?>

       <?= $form->field($model, 'client_id')->select(FHtml::getComboArray('crm_quotation', 'crm_quotation', 'client_id', true, 'id', 'name')) ?>

       <?= $form->field($model, 'client_name')->textInput() ?>

       <?= $form->field($model, 'client_description')->textarea(['rows' => 3]) ?>

       <?= $form->field($model, 'client_requirement')->textarea(['rows' => 3]) ?>

       <?= $form->field($model, 'expected_date')->date() ?>

       <?= $form->field($model, 'expired_date')->date() ?>

       <?= $form->field($model, 'completed_date')->date() ?>

       <?= $form->field($model, 'reason')->html() ?>

       <?= $form->field($model, 'note')->html() ?>

       <?= $form->field($model, 'year')->numeric() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('crm_quotation', 'crm_quotation', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'status')->select(FHtml::getComboArray('crm_quotation', 'crm_quotation', 'status', true, 'id', 'name'))->labelSpan(6) ?>
