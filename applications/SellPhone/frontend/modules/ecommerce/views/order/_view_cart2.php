    ...
    <div class="table-responsive">
        ...
        <table class="table table-responsive table-striped">
            ...
            <tr>
                ...
                <th class="col-xs-3"><?= FHtml::t('common', 'Item') ?></th>
                <th style="text-align:right !important;" class="col-xs-2"><?= FHtml::t('common', 'Unit Price') ?></th>
                <th class="col-xs-2"><?= FHtml::t('common', 'Quantity') ?></th>
                <th style="text-align:right !important;" class="col-xs-2"><?= FHtml::t('common', 'Sub Total') ?></th>
            </tr>
            </thead>
            <tbody>
            <?php
            foreach ($list_product as $row) {
                ...
                <tr id="item_<?= $row['id'] ?>">
                    ...
                    <td class="product-price"
                        style="text-align:right !important; line-height: 20"><?= FHtml::showPrice($row['old_price'], $row['price'], $row['discount'], $row['currency']) ?></td>
                    ...
                    <td class="product-price-total" style="text-align:right !important;" id="price_<?= $row['id'] ?>">
                        <?= FHtml::showPrice($row['price'] * $row['quantity'], $row['price'] * $row['quantity']); ?>
                    </td>
                    <td>
